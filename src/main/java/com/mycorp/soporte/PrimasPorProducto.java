...
/**
 * Clase PrimasPorProducto que contiene el identificador del producto y las
 * primas correspondientes para el desglose en facturación
 */
public class PrimasPorProducto implements Serializable {
	...
	/**
	 * @param primaProducto The primaProducto to set.
	 */
