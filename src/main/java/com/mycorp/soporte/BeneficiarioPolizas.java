...
public class BeneficiarioPolizas extends Beneficiario implements Serializable {
	 ...
	 *
	 * @param numAsegurado The numAsegurado to set.
	 */
	 ...
	 *
	 * @param swPolizaAnterior asigna lSwPolizaAnterior.
	 */
	 ...
	 *
	 * @param numTarjetaSanitas The sNumTarjetaSanitas to set.
	 */
	 ...
	 *
	 * @param swClienteAnterior The swClienteAnterior to set.
	 */
